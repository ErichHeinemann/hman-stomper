...
#ifndef _AUDIOGENERATORSAMPLE_H
#define _AUDIOGENERATORSAMPLE_H
...
class AudioGeneratorSAMPLE : AudioGenerator
{
  public:
    AudioGeneratorSAMPLE();
    virtual ~AudioGeneratorSAMPLE() override;
    virtual bool begin( AudioFileSource *source, AudioOutput *output, uint8_t velocity, uint8_t pitch ) override;
