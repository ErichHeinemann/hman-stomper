...
bool AudioOutputI2Sesp32::i2sOn = false;

AudioOutputI2Sesp32::AudioOutputI2Sesp32()
{
  if (!i2sOn) 
  {
  // ESP8266
...
bool AudioOutputI2Sesp32::SetRate(int hz)
{
...
bool AudioOutputI2Sesp32::SetBitsPerSample(int bits)
{
...
bool AudioOutputI2Sesp32::SetChannels(int channels)
{
...
bool AudioOutputI2Sesp32::SetOutputModeMono(bool mono)
{
  this->mono = mono;
  return true;
}

bool AudioOutputI2Sesp32::begin()
{
  // Nothing to do here, i2s will start once data comes in
  return true;
}

bool AudioOutputI2Sesp32::ConsumeSample(int16_t sample[2])
{
