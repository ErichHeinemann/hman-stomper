...
#ifndef _AUDIOMIXEROUTBUFFER_H
#define _AUDIOMIXEROUTBUFFER_H

#include "AudioOutput.h"

class AudioMixerOutBuffer : public AudioOutput
{
  public:
    AudioMixerOutBuffer(int bufferSizeSamples, AudioOutput *dest );
    virtual ~AudioMixerOutBuffer() override;
  ...
  inline int16_t LimitSample( int16_t s) {
    // this would be a good place to activate an PIN with an red LED as a Clipping-LED
