...
int16_t SampleAudioFilter::doLPF(int16_t input, uint8_t channel, uint8_t reso, uint8_t freq) {
...
int16_t SampleAudioFilter::doHPF(int16_t input, uint8_t channel, uint8_t reso, uint8_t freq) {
...
bool SampleAudioFilter::setMoogCoefficients(float frequency, float resonance) {
 q = 1.0f - frequency;
...
// MoogFilter
 bool SampleAudioFilter::updateMoogPrevOut(int16_t out, int channel) {
  if (channel==0) {
...
int16_t SampleAudioFilter::processMoog(int16_t in ,int channel) {
  in -= q * b4;//feedback
  t1 = b1;
  b1 = (in + b0) * p - b1 * f;
  t2 = b2;
...
int16_t SampleAudioFilter::doMoog( int16_t in, int channel  ){
