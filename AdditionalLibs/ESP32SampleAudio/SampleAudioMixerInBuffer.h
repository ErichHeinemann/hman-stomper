...
#ifndef _SAMPLEAUDIOMIXERINBUFFER_H
#define _SAMPLEAUDIOMIXERINBUFFER_H

#include "SampleAudioOutput.h"
#include "SampleAudioMixerOutBuffer.h"

class SampleAudioMixerInBuffer : public SampleAudioOutput
{
  public:
    SampleAudioMixerInBuffer(int bufferSizeSamples, SampleAudioMixerOutBuffer *dest, int mixChannelNo=0 );
    virtual ~SampleAudioMixerInBuffer() override;
  ...
  protected:
    SampleAudioMixerOutBuffer *sink;
    int buffSize;
    int16_t *leftSample;
    int16_t *rightSample;
    int writePtr;
