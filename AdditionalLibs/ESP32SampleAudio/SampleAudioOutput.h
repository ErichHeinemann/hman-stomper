...
#ifndef _SAMPLEAUDIOOUTPUT_H
#define _SAMPLEAUDIOOUTPUT_H

#include <Arduino.h>
#include "SampleAudioStatus.h"

class SampleAudioOutput
{
  public:
    SampleAudioOutput() { };
    virtual ~SampleAudioOutput() {};
  ...
  public:
    virtual bool RegisterMetadataCB(SampleAudioStatus::metadataCBFn fn, void *data) { return cb.RegisterMetadataCB(fn, data); }
    virtual bool RegisterStatusCB(SampleAudioStatus::statusCBFn fn, void *data) { return cb.RegisterStatusCB(fn, data); }
