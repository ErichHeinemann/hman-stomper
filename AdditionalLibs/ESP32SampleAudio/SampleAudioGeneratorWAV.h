...
#ifndef _SAMPLEAUDIOGENERATORWAV_H
#define _SAMPLEAUDIOGENERATORWAV_H

#include "SampleAudioGenerator.h"

class SampleAudioGeneratorWAV : public SampleAudioGenerator
{
  public:
    SampleAudioGeneratorWAV();
    virtual ~SampleAudioGeneratorWAV() override;
    virtual bool begin(SampleAudioFileSource *source, SampleAudioOutput *output) override;
