...
class SampleAudioOutputFilterDecimate : public SampleAudioOutput
{
  public:
    SampleAudioOutputFilterDecimate(uint8_t taps, const int16_t *tap, int num, int den, SampleAudioOutput *sink);
    virtual ~SampleAudioOutputFilterDecimate() override;
