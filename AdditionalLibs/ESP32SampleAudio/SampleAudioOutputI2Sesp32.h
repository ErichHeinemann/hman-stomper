...
#ifndef _SAMPLEAUDIOOUTPUTI2SESP32_H
#define _SAMPLEAUDIOOUTPUTI2SESP32_H

#include "SampleAudioOutput.h"

class SampleAudioOutputI2Sesp32 : public SampleAudioOutput
{
  public:
    SampleAudioOutputI2Sesp32();
    virtual ~SampleAudioOutputI2Sesp32() override;
